...
export default function Footer() {
    return (
        <div className={"w-full py-2 flex flex-col justify-center items-center z-10 shadow-inner"}>
            <div className={"w-full grid grid-cols-1 lg:grid-cols-2 text-center gap-4 py-5 mx-auto"}>
                ...
                <div className={"mx-auto flex flex-col justify-center text-center items-center gap-2"}>
                    ...
                    <div className={"flex gap-2"}>
                        <Link href={"/privacy"}><i className={"bi bi-shield-lock text-lg"}></i></Link>
                        <Link href={"/administration"}><i className="bi bi-person-lock text-lg"></i></Link>
                    </div>
                </div>
            </div>
        </div>
